...
pub const App = struct {
    ...
    pub fn run(self: *App) !void {
        ...
        self.state = .running;
        self.start_time_ns = currentTimestampNs();
    ...
    fn runFrame(self: *App) !void {
        const current_time = currentTimestampNs();
        ...
        const elapsed_ns = currentTimestampNs() - current_time;
    ...
    fn processInput(self: *App) !void {
        ...
        const stdin = if (builtin.os.tag == .windows)
            ...
            std.Io.File{ .handle = std.posix.STDIN_FILENO };
    ...
    fn render(self: *App) !void {
        ...
        var ctx = RenderContext{
            ...
            .focused_id = null,
            .time_ns = @intCast(currentTimestampNs() - self.start_time_ns),
        };
    ...
    pub fn getElapsedTime(self: *App) u64 {
        const ns = currentTimestampNs() - self.start_time_ns;
